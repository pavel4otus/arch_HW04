...
public class GoodsServiceImpl implements GoodsService {
    ...
    @Autowired private GoodMskRepo mskRepository;
    @Autowired private GoodSpbRepo spbRepository;
    @Autowired private GoodProvincialRepo othRepository;
    ...
    private String getNearestCity( User user){
        ...
        if( user.getAddress().indexOf( "Москва", 0) > 0) { result = "MSK";}
        if( user.getAddress().indexOf( "Санкт-Петербург", 0) > 0) { result = "SPB";}
