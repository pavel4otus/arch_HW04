...
CREATE TABLE IF NOT EXISTS authorities (
  ...
  create table goods_spb (id  bigserial not null, description varchar(255), largepictureurl varchar(255), name varchar(255), skud int8, smallpictureurl varchar(255), brand_id int8, category_id int8, primary key (id));
  create table goods_msk (id  bigserial not null, description varchar(255), largepictureurl varchar(255), name varchar(255), skud int8, smallpictureurl varchar(255), brand_id int8, category_id int8, primary key (id));
  create table goods_oth (id  bigserial not null, description varchar(255), largepictureurl varchar(255), name varchar(255), skud int8, smallpictureurl varchar(255), brand_id int8, category_id int8, primary key (id));
