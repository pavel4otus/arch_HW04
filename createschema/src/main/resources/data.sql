...
-- товары
--
insert into goods( id, skud, name, description, category_id, brand_id)values ( 1, 1, 'Телевизор 1', 'Телевизр', 1, 1 );
insert into goods( id, skud, name, description, category_id, brand_id)values ( 2, 1, 'Телевизор 2', 'Телевизр', 1, 2 );
insert into goods( id, skud, name, description, category_id, brand_id)values ( 3, 1, 'Телевизор 3', 'Телевизр', 1, 3 );
insert into goods( id, skud, name, description, category_id, brand_id)values ( 4, 1, 'Сотовый телефон 1', 'Сотовый телефон', 2, 2 );
insert into goods( id, skud, name, description, category_id, brand_id)values ( 5, 1, 'Сотовый телефон 2', 'Сотовый телефон', 2, 2 );

insert into goods_spb( id, skud, name, description, category_id, brand_id)values ( 1, 1, 'SPB.Телевизор 1', 'Телевизр', 1, 1 );
insert into goods_spb( id, skud, name, description, category_id, brand_id)values ( 2, 1, 'SPB.Телевизор 2', 'Телевизр', 1, 2 );
insert into goods_spb( id, skud, name, description, category_id, brand_id)values ( 3, 1, 'SPB.Телевизор 3', 'Телевизр', 1, 3 );
insert into goods_spb( id, skud, name, description, category_id, brand_id)values ( 4, 1, 'SPB.Сотовый телефон 1', 'Сотовый телефон', 2, 2 );
insert into goods_spb( id, skud, name, description, category_id, brand_id)values ( 5, 1, 'SPB.Сотовый телефон 2', 'Сотовый телефон', 2, 2 );

insert into goods_msk( id, skud, name, description, category_id, brand_id)values ( 1, 1, 'MSK.Телевизор 1', 'Телевизр', 1, 1 );
insert into goods_msk( id, skud, name, description, category_id, brand_id)values ( 2, 1, 'MSK.Телевизор 2', 'Телевизр', 1, 2 );
insert into goods_msk( id, skud, name, description, category_id, brand_id)values ( 3, 1, 'MSK.Телевизор 3', 'Телевизр', 1, 3 );
insert into goods_msk( id, skud, name, description, category_id, brand_id)values ( 4, 1, 'MSK.Сотовый телефон 1', 'Сотовый телефон', 2, 2 );
insert into goods_msk( id, skud, name, description, category_id, brand_id)values ( 5, 1, 'MSK.Сотовый телефон 2', 'Сотовый телефон', 2, 2 );

insert into goods_oth( id, skud, name, description, category_id, brand_id)values ( 1, 1, 'ОСТАЛЬНЫЕ.Телевизор 1', 'Телевизр', 1, 1 );
insert into goods_oth( id, skud, name, description, category_id, brand_id)values ( 2, 1, 'ОСТАЛЬНЫЕ.Телевизор 2', 'Телевизр', 1, 2 );
insert into goods_oth( id, skud, name, description, category_id, brand_id)values ( 3, 1, 'ОСТАЛЬНЫЕ.Телевизор 3', 'Телевизр', 1, 3 );
insert into goods_oth( id, skud, name, description, category_id, brand_id)values ( 4, 1, 'ОСТАЛЬНЫЕ.Сотовый телефон 1', 'Сотовый телефон', 2, 2 );
insert into goods_oth( id, skud, name, description, category_id, brand_id)values ( 5, 1, 'ОСТАЛЬНЫЕ.Сотовый телефон 2', 'Сотовый телефон', 2, 2 );
